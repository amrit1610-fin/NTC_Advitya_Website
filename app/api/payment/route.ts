...
export async function POST(request: NextRequest) {
    ...
    `
      ...
      INSERT INTO payments (team_id, amount, payment_screenshot, payment_status)
      VALUES (${teamId}, ${amount}, ${paymentScreenshot}, 'uploaded')
      RETURNING id
    `
...
// GET endpoint to retrieve payment details (for admin purposes)
